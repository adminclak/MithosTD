...
1. **Esqueleto da partida** — mapa, caminho, slots, 1 torre que atira, ondas, vida da base. *(Já dá pra jogar.)*
2. **As 4 classes** — incluindo o sistema de bloqueio do Guerreiro e o suporte do Sacerdote.
